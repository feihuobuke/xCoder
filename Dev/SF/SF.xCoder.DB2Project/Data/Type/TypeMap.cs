...
using SF.xCoder.DB2Project.Attributes;
...
namespace SF.xCoder.DB2Project.Data.Type
{
    public struct TypeMap
    {
        ...
        [DBType("Int")] [DBType("numeric")] public const string Int = "int";

        [DBType("Money")] public const string Money = "float";

        [DBType("NChar")] public const string NChar = "string";

        [DBType("NText")] public const string NText = "string";

        [DBType("NVarChar")] public const string NVarChar = "string";
        ...
        public static string GetTypeString(string dbTypeString, bool isNull)
        {
            ...
            return isNull && !tmp.Contains("[]") && !tmp.Equals("string", StringComparison.OrdinalIgnoreCase)
                       ? (tmp + "?")
                       : tmp;
        }
    }
